...
export default {
  ...
  methods: {
    ...
    async doSubmit() {
      ...
      const selectedAc = this.allAccounts.filter((a) => {
        return a.checked;
      });
  ...
  <div class="appsync-wrapper">
    ...
    <el-dialog
      ...
      <div v-if="extensionInstalled">
        <h6>账号</h6>
        <div v-if="!submitting" class="all-pubaccounts">
          <div v-for="account in allAccounts" class="account-item">
        ...
        <div v-if="submitting && taskStatus" class="all-pubaccounts">
